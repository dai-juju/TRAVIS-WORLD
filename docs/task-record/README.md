...
|---|---|---|---|---|
| M3 | Step 4 | 린 워커 위생 ([10-110] shutdown 풀 견고화 + [10-117] 청산 2단 가드 + [10-118] 1h refresh·자기 재시작 — 7/14 좀비 근본 해소, o.st 중첩 오독 재정정) | 2026-07-22 | [M3-step4-lean-worker-hygiene.md](./M3-step4-lean-worker-hygiene.md) |
