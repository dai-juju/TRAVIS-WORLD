...
- [M2 Stage4후 우선순위 판정](project_m2_post_stage4_priority.md) — 격자완성=Stage 1b(scalar/record data-locked 2종 청산)까지, Stage 1~4≠완성. 권장순서 1.Stage1b 2.[10-84]청산집계 3.히트맵. OKX/뉴스 개방=Stage1b후(+[8-27]#5/#6). [10-100]=별개 유지보수.
- [M3-step3 청산 series breakdown](project_m3_step3_liquidation_series_breakdown.md) — [10-84] 6-step(~11~16.5h). ★"chart 0줄"은 per-symbol+총합에서만 참(ChartCard symbols 0 차단·단일 valueField). 갈림길 3(집계위치 RPC경로이탈/시장전체/side분리). 회수 [10-81] IN·[10-83] 부분·[10-98] 조건부. G2 외부대조 기준 부재.
