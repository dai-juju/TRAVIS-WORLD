...
##### Steps (2026-06-27 분해) · Phase A(1~5 코드·휴면) / Phase B(6 라이브, 사용자 협업) — **진행 (2026-06-28): Step 1·3a·3b·2·4 ✅ + `[10-71]` 회수 (Phase A non-web 전부 + web 피드 훅, 화면 변화 0). 다음 = Step 5 **재정의 = 모양-제네릭 Feed form**(composable Stage 3 = ff#2 재개, 옛 LiquidationFeedCard 아님 — `M2-composable §11`, 사용자 확정 2026-06-30). 단일 진실 `docs/task-record/M2-pathA-ff2-liquidation.md`.**
